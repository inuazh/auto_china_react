            ...
            <div className="card__img-wrap">
              <div className="card__img-2">
                <img
                  ...
                  alt="Haval"
                  onMouseOver={() => changeImage(haval1)}
                />
              </div>
              <div className="card__img-2">
                <img
        ...
        <div className="card__description">
          <div className="card__text">
            ...
            <p>
              ...
              M6&nbsp;отвечает духу времени и&nbsp;подчеркивает практичный
              характер автомобиля.
            </p>
            <p>
              ...
              образует единый элемент в форме крыльев, передавая ощущение
              скорости и полета. Сильный характер кроссовера чувствуется в
              массивном корпусе с выраженными колесными арками. Горизонтальные
              задние фары образуют сплошную линию на всю ширину кузова
              автомобиля, подчеркивая современность его стиля.
            </p>
            <p>
